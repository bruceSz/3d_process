...
from pointnetPlus.pointnet2_modules import PointnetFPModule, PointnetSAModuleMSG
import pointnetPlus.pytorch_utils as pt_utils


def get_model(input_channels=0):
    return PointnetPlus(input_channels=input_channels)
