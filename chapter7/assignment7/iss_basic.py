...
def get_args():
    ...
    parase.add_argument("--file_name",type=str,default= "../../dataset/modelnet40_normal_resampled/lamp/lamp_0001.txt")
...
if __name__ == "__main__":
    ...
    print("shape of df after nms: ",len(df_data))
    # 排除非极大值点
    df_data = df_data.loc[df_data["id"].apply(lambda id:not id in suppressed),df_data.columns]

    print("min shape of df with l1: ", min(df_data["l1"]))
    # 排除不符合协方差要求的点
